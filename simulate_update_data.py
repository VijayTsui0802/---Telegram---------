...
class UpdateDataWorker(QThread):
    ...
    def __init__(self, account_id: int, cookie: str, token: str):
        super().__init__()
    ...
    def make_request(self):
        ...
        data = {
            ...
            "conversation_update_time": int(time.time())
        }
...
class UpdateDataWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        auth_group_layout.addLayout(cookie_layout)
        ...
        self.account_id_input.setValue(8114563)
    ...
    def start_request(self):
        ...
        # 创建工作线程
        self.worker = UpdateDataWorker(account_id, cookie, token)
